...
int main() {
    ...
    if (choice == 1) {
        Generator element(3359, 0, 10000, 1);
        ...
        for (long i = 0; i < 100; i++)
            data100.push_back(element.next());
        ...
        for (long i = 0; i < 500; i++)
            data500.push_back(element.next());
        ...
        for (long i = 0; i < 1000; i++)
            data1000.push_back(element.next());
        ...
        for (long i = 0; i < 5000; i++)
            data5000.push_back(element.next());
        ...
        for (long i = 0; i < 10000; i++)
            data10000.push_back(element.next());
        ...
        for (long i = 0; i < 50000; i++)
            data50000.push_back(element.next());
        ...
        for (long i = 0; i < 100000; i++)
            data100000.push_back(element.next());
        ...
        for (long i = 0; i < 500000; i++)
            data500000.push_back(element.next());
        ...
        for (long i = 0; i < 1000000; i++)
            data1000000.push_back(element.next());
        ...
        for (long i = 0; i < 5000000; i++)
            data5000000.push_back(element.next());
    ...
    if (choice == 2) {
        Generator element(3359, 0, 10000, 2);
        ofstream out("output.txt");
        vector <int> data100 = {},
            data500 = {},
            data1000 = {},
